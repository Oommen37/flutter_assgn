...
import 'package:flutter_assgn/Farmers%20Fresh%20UI/blog_ref_wid.dart';
import 'package:flutter_assgn/Farmers%20Fresh%20UI/refct_wid.dart';
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage('assets/v3.png'), fit: BoxFit.cover)),
              ),
            ),
          ),
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage('assets/v2.png'), fit: BoxFit.cover)),
              ),
            ),
          ),
                        ...
                        child: Stack(
                          children: [
                            const Positioned(
                                ...
                                child: CircleAvatar(
                                    backgroundImage:
                                        AssetImage('assets/futurerapper.jpg'))),
                            const Positioned(
                                top: 15, left: 60, child: Text('Oommen')),
                            const Positioned(
                                top: 30,
                                left: 60,
