...
import 'package:flutter_assgn/Tourism%20App%20Project/data/dummydata.dart';
          ...
          children: [
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: NetworkImage(detail['description image']),
                        fit: BoxFit.cover)),
              ),
            ),
            Column(
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () =>
                    Navigator.of(context).pushNamed('explore', arguments: id),
                child: Container(
                  height: 40,
                  width: 450,
                  decoration: BoxDecoration(
