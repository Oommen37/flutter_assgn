        ...
        children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: NetworkImage(
                            'https://images.unsplash.com/photo-1564501049412-61c2a3083791?auto=format&fit=crop&q=80&w=1332&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'),
                        fit: BoxFit.cover)),
              ),
              Positioned(
                  top: 200,
                  left: 10,
                  child: Text(
                    'Hôtel du Louvre,Place Andre Malraux, Paris',
                    style: TextStyle(
                      color: Colors.white,
            ...
            children: [
              RatingBar.builder(
                ...
                itemPadding: EdgeInsets.symmetric(
                    horizontal: 4.0), // Padding between items
          ...
          GestureDetector(
            onTap: () => Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => Tour_Payment())),
            child: Container(
              height: 50,
              width: 400,
              alignment: Alignment.center,
